    ...
    return (
        <div className="bg-brand-medium p-6 rounded-xl shadow-lg h-full flex flex-col">
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {posts.map((post, index) => (
                        <div key={post.id || index} className="relative rounded-lg overflow-hidden group aspect-square">
            ...
            <div className="mt-auto pt-4 text-center">
                <a 
                    href="/#/showcase"
                    className="text-brand-orange hover:underline font-semibold text-sm transition-colors"
                >
                    {t('viewMoreLink')} &rarr;
                </a>
            </div>
