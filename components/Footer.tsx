            ...
            <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2 order-2">
                        <a href="#" className="text-sm text-gray-300 hover:text-brand-orange transition-colors">About</a>
                        <a href="#" className="text-sm text-gray-300 hover:text-brand-orange transition-colors">Privacy Policy</a>
                        <a href="#" className="text-sm text-gray-300 hover:text-brand-orange transition-colors">Terms of Service</a>
                    </nav>
